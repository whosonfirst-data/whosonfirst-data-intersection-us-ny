...
tools:
	make tools-fetch TARGET=darwin
	make tools-verify TARGET=darwin
	make tools-fetch TARGET=linux
	make tools-verify TARGET=linux
	make tools-fetch TARGET=windows
